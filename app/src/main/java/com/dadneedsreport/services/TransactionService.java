...
public class TransactionService {
	...
	private final String notFound = "Transaction Not Found";
	...
	public List<TransactionResponse> getTransactionsByType(TransactionType type) {
		Long userId = getUser().getId();
		List<Transaction> transact = incomeEntity.findAllByTypeAndUserId(type, userId, SecurityConfig.getFindAllLimit()).getContent();
		if (transact.isEmpty())
			new EntityNotFoundException("THERE ARE NO " + type.toString());
	...
	public List<TransactionResponse> getTransactions() {
		Long userId = getUser().getId();
		List<Transaction> transacts = incomeEntity.findAllByUserId(userId, SecurityConfig.getFindAllLimit()).getContent();
